...
#200201 this script obtained from woof-ce legacy-branch.
#200208 easypup has init script in initrd older than that in woof-ce, wants pupsaveresize.txt.
#200508 TEXTDOMAIN "pup_" prepended.

export TEXTDOMAIN=pup_resizepfile.sh
...
case ${EXIT} in
  save)KILOBIG=$(($KILOBIG * 1024))
	...
	#200208 easypup has init script in initrd older than that in woof-ce, wants this...
